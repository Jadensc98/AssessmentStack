...
export class PostComponent implements OnInit {
  ...
  constructor(
    //Private postservice will be injected into the component by Angular Dependency Injector
    private postService: PostService
  ) { }

  //Declaring the new post Object and initilizing it
  public newPost: Post = new Post()

  //An Empty list for the visible post list
  postsList: Post[];
  editPosts: Post[] = [];
